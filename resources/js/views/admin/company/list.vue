        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                    <h5 class="font-medium text-uppercase mb-0">Lista de {{ userLogged.branch_id == 2 ? 'Empresas' : 'Fornecedores' }}</h5>
                </div>
                <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                    <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                        <ol class="breadcrumb mb-0 justify-content-end p-0">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Lista de {{ userLogged.branch_id == 2 ? 'Empresas' : 'Fornecedores' }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div style="margin: 5px 0px 35px 0px;">
                        <router-link :to="{name: 'admin.user.create'}" class="btn btn-success text-white">Criar {{ userLogged.branch == 1 ? 'Fornecedor' : 'Empresa' }}<i style="margin-left: 10px;" class="fa fa-plus"></i> </router-link>
                    </div>
